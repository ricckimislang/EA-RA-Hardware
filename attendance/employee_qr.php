...
<head>
    ...
    <title>Employee QR Codes - EA-RA Hardware</title>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="btn-group gap-3">
                <a href="reports.php" class="btn btn-primary">Attendance Reports</a>
                <a href="employee_qr.php" class="btn btn-secondary">View Employee QR Codes</a>
            </div>
        </div>
